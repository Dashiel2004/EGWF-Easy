...
pub fn install() {
    Agent::new("demon")
        .game_acmd("game_appealhil", game_appealhi, Default)
        .effect_acmd("effect_appealhil", effect_appealhi, Default)
        .sound_acmd("sound_appealhil", sound_appealhi, Default)
        .expression_acmd("expression_appealhil", expression_appealhi, Default)
        .game_acmd("game_appealhir", game_appealhi, Default)
        .effect_acmd("effect_appealhir", effect_appealhi, Default)
        .sound_acmd("sound_appealhir", sound_appealhi, Default)
        .expression_acmd("expression_appealhir", expression_appealhi, Default)
        .install();
}
